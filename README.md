...
[下载 v0.1.1](https://github.com/Nuclear2/cmo-agent-bridge/releases/tag/v0.1.1) ·
...
> **当前版本是 v0.1.1 预览版。** 已在 Windows、CMO Build 1868 上验证；第一次接入建议使用
> 想定副本。
...
执行 `/reload-plugins` 或新建会话即可载入。Codex 和 Claude 的 plugin 都同时包含 MCP 配置和
完整的 `operate-cmo` Skill。
...
- 当前版本：[`v0.1.1 Preview`](https://github.com/Nuclear2/cmo-agent-bridge/releases/tag/v0.1.1)
