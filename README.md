...
[下载 v0.1.3](https://github.com/Nuclear2/cmo-agent-bridge/releases/tag/v0.1.3) ·
...
> **当前版本是 v0.1.3 预览版。** 已在 Windows、CMO Build 1868 上验证；第一次接入建议使用
> 想定副本。
...
- 当前版本：[`v0.1.3 Preview`](https://github.com/Nuclear2/cmo-agent-bridge/releases/tag/v0.1.3)
