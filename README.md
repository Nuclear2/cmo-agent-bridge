...
[下载 v0.3.1](https://github.com/Nuclear2/cmo-agent-bridge/releases/tag/v0.3.1) ·
...
> **当前版本是 v0.3.1 预览版。** 已在 Windows、CMO Build 1868 上验证；第一次接入建议使用
> 想定副本。
...
- 当前版本：[`v0.3.1 Preview`](https://github.com/Nuclear2/cmo-agent-bridge/releases/tag/v0.3.1)
