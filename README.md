...
[下载 v0.2.1](https://github.com/Nuclear2/cmo-agent-bridge/releases/tag/v0.2.1) ·
[快速上手](docs/quickstart.md) ·
[各框架安装](docs/frameworks/README.md) ·
[CMO Lua API](https://commandlua.github.io/)

CMO Agent Bridge 将推演和想定制作中常用的 Lua API 整理成 76 个结构化 MCP 工具。Agent
...
> **当前版本是 v0.2.1 预览版。** 已在 Windows、CMO Build 1868 上验证；第一次接入建议使用
> 想定副本。
...
- **MCP Server** 提供 76 个 `cmo_*` 工具，负责主机准备、诊断、持久写队列以及读取和修改 CMO 状态；
...
- 当前版本：[`v0.2.1 Preview`](https://github.com/Nuclear2/cmo-agent-bridge/releases/tag/v0.2.1)
