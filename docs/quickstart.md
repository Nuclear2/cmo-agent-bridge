...
`v0.1.0` 是 Preview / GitHub Pre-release。请在想定副本上完成首次验证。
...
按框架选择配置：[Codex](frameworks/codex.md)、
[Claude Code](frameworks/claude-code.md)、[OpenCode](frameworks/opencode.md)、
[Cursor](frameworks/cursor.md)、[Qoder](frameworks/qoder.md) 或
[通用 MCP](frameworks/generic-mcp.md)。
